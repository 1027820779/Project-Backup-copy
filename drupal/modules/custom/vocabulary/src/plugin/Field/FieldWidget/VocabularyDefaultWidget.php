...
namespace Drupal\vocabulary\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'VocabularyDefaultWidget' widget.
 *
 * @FieldWidget(
 *   id = "VocabularyDefaultWidget",
 *   label = @Translation("Vocabulary select"),
 *   field_types = {
 *     "Vocabulary"
 *   }
 * )
 */
class VocabularyDefaultWidget extends WidgetBase {
